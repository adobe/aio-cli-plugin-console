...
const TheCommand = require('../../../../src/commands/console/workspace')
...
test('aliases', async () => {
  expect(TheCommand.aliases).toEqual(['workspace'])
})
  ...
  describe('run', () => {
    ...
    test('returns help file for console command', () => {
      ...
      return command.run().then(() => {
        expect(spy).toHaveBeenCalledWith(['console:workspace', '--help'])
      })
    })
  })
})
